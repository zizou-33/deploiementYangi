...
export const API = {
  ...
  chat: {
    rooms: `${API_URL}/api/chat/rooms/`,
    room: (id: number) => `${API_URL}/api/chat/rooms/${id}/`,
    messages: (roomId: number) => `${API_URL}/api/chat/rooms/${roomId}/messages/`,
    ws: (roomId: number) => `ws://localhost:8000/ws/chat/${roomId}/`,
  },
};
